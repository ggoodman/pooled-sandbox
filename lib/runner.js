...
function onUncaughtException(e) {
    ...
    typeof tripwireContext !== 'undefined'
        ?   onResult(createError('SandboxUnhandledError', 'Sandboxed code blocked the event loop for more than ' + tripwireContext.timeout + 'ms', e))
        :   onResult(createError('SandboxUnhandledError', 'Sandboxed code generated an unhandled exception: ' + e.message, e));
